...
export default function LoaderComponent(props: any) {
    ...
    return (
        <Box  sx={{ position: _loaderStyle.position, mt: _loaderStyle.mt, width: _loaderStyle.width, display: loading ? "block" : "none" }}>
        <LinearProgress color={_loaderStyle.color} sx={{
